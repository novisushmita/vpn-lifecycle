...
|
| 'router' menandai pengaturan yang perubahannya harus dirambatkan ke
| MikroTik, bukan sekadar disimpan di basis data.
*/
...
return [
    'bawaan' => [
        ...
        'alamat_server_vpn' => [
            ...
            'bantuan'    => 'Alamat yang dikirim ke pemohon lewat email dan dipakai klien untuk terhubung. Bukan alamat manajemen router.',
            'tipe'       => 'teks',
            'router'     => false,
        ],
        'dns_klien' => [
            'nilai'      => '8.8.8.8,1.1.1.1',
            'label'      => 'DNS untuk klien VPN',
            'bantuan'    => 'Dipisah koma. Tanpa ini klien dapat menjangkau VPS lewat alamat IP tetapi tidak dapat membuka nama domain.',
            'tipe'       => 'teks',
            'router'     => true,
        ],
