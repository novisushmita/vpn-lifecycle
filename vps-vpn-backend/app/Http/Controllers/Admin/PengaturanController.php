...
use App\Jobs\TerapkanPengaturanRouterJob;
...
class PengaturanController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        foreach ($data['pengaturan'] as $baris) {
            ...
            $sentuhRouter = $sentuhRouter || $meta['router'];
        }
        ...
        // Hanya pengaturan bertanda router yang perlu dirambatkan.
        if ($sentuhRouter) {
            TerapkanPengaturanRouterJob::dispatch($request->user()->id);
        }
        ...
        return response()->json([
            'message'        => $sentuhRouter
                ? 'Pengaturan disimpan. Perubahan pada router sedang diterapkan.'
                : 'Pengaturan disimpan.',
            'jumlah_diubah'  => count($diubah),
            'menyentuh_router' => $sentuhRouter,
        ]);
    }
}
