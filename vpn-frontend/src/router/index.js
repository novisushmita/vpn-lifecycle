...
const routes = [
  ...
  { path: "/bantuan", name: "bantuan", component: Bantuan, meta: { title: "Kontak Administrator" } },
  ...
  // ---------- Dashboard admin ----------
  {
    ...
    children: [
      ...
      { path: "pengajuan", name: "admin-pengajuan", component: PengajuanList, meta: { title: "Data Pengajuan", grup: "Kelola" } },
      { path: "pengajuan/:id", name: "admin-pengajuan-detail", component: PengajuanDetail, meta: { title: "Detail Pengajuan", grup: "Kelola" } },
      { path: "akun", name: "admin-akun", component: AkunList, meta: { title: "Akun VPN", grup: "Kelola" } },
      { path: "akun/:id", name: "admin-akun-detail", component: AkunDetail, meta: { title: "Detail Akun", grup: "Kelola" } },
      { path: "vps", name: "admin-vps", component: VpsList, meta: { title: "Daftar VPS", grup: "Kelola" } },
      { path: "sinkronisasi", name: "admin-drift", component: DriftList, meta: { title: "Pemeriksaan Router", grup: "Kelola" } },
      { path: "pengaturan", name: "admin-pengaturan", component: Pengaturan, meta: { title: "Pengaturan", grup: "Kelola" } },
    ],
  },
];
